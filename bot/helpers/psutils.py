...
PS_SITES = {
    ...
    "-h": "https://hiperdex.com/manga/",
    "-m18c": "https://manga18.club/manhwa/",
}
...
async def ps_link(site, name, chapter=None, chapter_suffix=True):
    ...
    if site == "-ws":
        chapter_suffix = False

    if chapter:
        link = link.rstrip("/") + (
            f"/chapter-{chapter}" if chapter_suffix else f"/{chapter}"
        )
